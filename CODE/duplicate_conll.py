...
def main():
    ...
    filepath_list = ['../DATA/UP_English-EWT/en_ewt-up-test.conllu', 
                     '../DATA/UP_English-EWT/en_ewt-up-dev.conllu', 
                     '../DATA/UP_English-EWT/en_ewt-up-train.conllu']
    
    for infile in filepath_list:
        outfile = infile.replace('.conllu','.duplicated.conll')   
        ...
        with open(outfile, 'a', encoding = 'utf-8') as outputfile:
